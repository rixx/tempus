...
urlpatterns = [
    ...
    url(r'^(?P<category>[a-zA-Z0-9]+)/(?P<pk>[a-zA-Z0-9]+)/delete$', views.DeleteProjectView.as_view(), name='delete_project'),
    url(r'^(?P<category>[a-zA-Z0-9]+)/(?P<project>[a-zA-Z0-9]+)/$', views.ProjectView.as_view(), name='project'),
